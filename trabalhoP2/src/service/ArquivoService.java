...
public class ArquivoService {
	...
	private static final String ARQUIVO_USUARIOS = "contatos/usuarios.txt";
    private static final String PASTA_CONTATOS = "contatos/";
	
    public static void salvarUsuario(Usuario usuario) throws IOException {
        if (usuario.getEmail() == null || usuario.getEmail().isEmpty()) {
            throw new IOException("Email do usuário inválido");
        }
    ...
    public static void salvarContatos(Usuario usuario) throws IOException {
        String nomeArquivo = PASTA_CONTATOS + usuario.getNome() + ".txt";
    ...
    public static List<Agenda> carregarContatos(Usuario usuario) throws IOException {
        ...
        String nomeArquivo = PASTA_CONTATOS + usuario.getNome() + ".txt";        File file = new File(nomeArquivo);
    ...
    public static void removerUsuario(Usuario usuario) throws IOException {
        ...
        String nomeArquivo = PASTA_CONTATOS + usuario.getNome() + ".txt";        File arquivoContatos = new File(nomeArquivo);
